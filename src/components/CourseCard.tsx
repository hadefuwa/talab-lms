...
export default function CourseCard({ course }: Props) {
  ...
  return (
    <Link
      ...
      className="group block bg-gray-900 border border-gray-800 rounded-2xl p-6 hover:border-talab-700 hover:shadow-lg hover:shadow-talab-900/20 transition-all duration-200"
    >

...
export default function LessonList({ lessons, courseId, progressMap }: Props) {
  if (lessons.length === 0) {
    return (
      ...
      {lessons.map((lesson, idx) => {
        ...
        return (
          <Link
            ...
            className="group flex items-center gap-4 bg-gray-900 border border-gray-800 rounded-xl px-5 py-4 hover:border-talab-700 hover:bg-gray-900/80 transition-all"
          >
